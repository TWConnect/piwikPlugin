...
class GetRepeatingSearchCount extends Base
{
    ...
    public function configureView(ViewDataTable $view)
    {
        if (!empty($this->dimension)) {
            $view->config->addTranslations(array('label' => $this->dimension->getName(),
                'repeating_rate' => Piwik::translate('MyThoughtWorks_RepeatingSearchRate'),
    ...
    protected function init()
    {
        ...
        $this->name = Piwik::translate('MyThoughtWorks_RepeatingSearchCount');
        $this->dimension = new DateDimension();
//        $this->processedMetrics = array(
//            new RepeatingRate()
//        );
        $this->documentation = Piwik::translate('MyThoughtWorks_RepeatingSearchCountDocument') . '<br /><br />'
//            . '<b>Repeating Search Rate = </b>' . Piwik::translate('MyThoughtWorks_RepeatingSearchRateCalculate') . '<br />'
        ...
        $this->metrics = array('repeating_search_count', 'total_search_count'/*, 'bounce_rate', 'repeating_rate'*/);
